...
/**************************
         配置IO口
**************************/
#define  SET_SPI_CS    HAL_GPIO_WritePin( GPIOA,GPIO_PIN_4 ,GPIO_PIN_SET)	  //把GPIOA port 0升为高电平(PA4=1)
#define  CLR_SPI_CS    HAL_GPIO_WritePin( GPIOA,GPIO_PIN_4 ,GPIO_PIN_RESET)	  //把GPIOA port 0降为低电平(PA4=0)

#define  SET_RC522RST   HAL_GPIO_WritePin(GPIOA,GPIO_PIN_2,GPIO_PIN_SET)	  //把GPIOA port 1升为高电平(PA2=1)
#define  CLR_RC522RST   HAL_GPIO_WritePin(GPIOA,GPIO_PIN_2,GPIO_PIN_RESET)	  //把GPIOA port 1降为低电平(PA2=0)
